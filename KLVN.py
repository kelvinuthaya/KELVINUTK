...
selection = st.sidebar.radio("Aller à :", list(sections.keys()))

if selection:
    st.markdown(sections[selection])
...
st.image(PROJECT_AADMSI_IMG, caption="Projet Acquisition de Données", use_container_width=True)
